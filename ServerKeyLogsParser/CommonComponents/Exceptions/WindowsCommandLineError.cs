...
{
    class WindowsCommandLineError : Exception, ConcreteException
    {
        public WindowsCommandLineError() : base() { }

        public WindowsCommandLineError(string message) : base(message) { }
